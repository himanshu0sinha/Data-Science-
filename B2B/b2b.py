...
#looking for any data containing missing values
...
#merge order report and SKU master datasets
...
#merging the pincodes with the main dataframes
merged2 = merged_data.merge(pincodes, on='Order ID')

merged2['Weights (Kgs)'] = merged2['Weight (g)'] / 1000

#calculate weight in slabs
...
#merging it with the courier invoice to display final dataframe

merged_output = merged2.merge(courier_invoice, on='Order ID')
print(merged_output.head())

#calculate difference in charges and expected charges
